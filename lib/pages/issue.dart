...
class _IssuePageState extends State<IssuePage>
  ...
  void _calculateStats() {
    _totalIssuedQty = _filteredIssues.fold<double>(
      0,
      (total, issue) => total + ((issue['quantity'] as num?)?.toDouble() ?? 0),
    );
    _totalIssuedValue = _filteredIssues.fold<double>(
      0,
      (total, issue) => total + (_getTotalValue(issue)),
    );
  }
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: SingleChildScrollView(
                              child: DataTable(
                                ...
                                columns: [
                                  _buildDataColumn('SL', 40, numeric: true),
                                  _buildDataColumn('Date', 80),
                                  _buildDataColumn('Voucher No', 100),
                                  _buildDataColumn('PO No', 90),
                                  _buildDataColumn('Article', 110),
                                  _buildDataColumn('Color', 80),
                                  _buildDataColumn('Qty', 70, numeric: true),
                                  _buildDataColumn(
                                    'Unit Price',
                                    90,
                                    numeric: true,
